...
def parsePoint(line):
    ...
    return LabeledPoint(ps.pop(0), ps)
...
labelsAndPreds = parsedValData.map(lambda observation: getLabeledPrediction(weightsLR0, observation))
